    ...
    <div className="flex flex-col mb-8 w-full max-w-lg px-4">
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-center gap-4 w-full">
        ...
        <Link
          ...
          className="relative overflow-hidden w-full sm:w-[280px] h-12 md:h-14 px-4 sm:px-8 rounded-xl flex cursor-pointer items-center justify-center gap-2.5 text-[15px] sm:text-[17px] font-medium text-white bg-white/[0.03] border border-white/10 backdrop-blur-3xl shadow-xl transition-all group hover:bg-white/[0.08] hover:border-white/20 hover:scale-[1.02] hover:-translate-y-0.5 active:scale-[0.98] whitespace-nowrap"
        >
