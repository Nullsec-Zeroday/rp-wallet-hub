...
export function AuroraGlow({ isStatic = false, className }: { isStatic?: boolean; className?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Central hero glow */}
      <div className={cn("absolute left-1/2 -translate-x-1/2 top-[150px] h-[350px] w-[350px] rounded-full bg-[#ec4899] opacity-[0.20] blur-[100px] md:h-[500px] md:w-[500px] md:blur-[160px]", !isStatic && "animate-aurora-3")} />
