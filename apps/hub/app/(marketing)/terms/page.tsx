          ...
          <FadeIn delay={200} direction="up">
            <section className="bg-white/[0.02] border border-white/[0.04] rounded-[24px] p-8 md:p-10 backdrop-blur-xl">
              ...
              <div className="space-y-6 text-[16px] text-[#A1A1AA] leading-relaxed">
                ...
                <p>
                  We are <strong>not affiliated with, endorsed by, or connected to Phantom, Solana Labs, Solana Foundation, Ledger SAS, Trust, Binance, or any other wallet provider, blockchain project, cryptocurrency exchange, or financial institution</strong>. Any visual similarities to existing wallet interfaces are for entertainment and parody purposes only.
                </p>
              </div>
            </section>
          </FadeIn>
